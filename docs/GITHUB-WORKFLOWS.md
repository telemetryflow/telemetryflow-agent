...
| ----------------- | ----------------------- | ------------- |
| `{version}`       | Full semantic version   | `1.2.1`      |
...
workflow_dispatch:
  inputs:
    version:
      description: "Version tag (e.g., 1.2.1)"
      required: false
    push:
...
docker pull ghcr.io/{owner}/telemetryflow-agent:1.3.2

# Docker Hub
docker pull telemetryflow/telemetryflow-agent:latest
docker pull telemetryflow/telemetryflow-agent:1.3.2
```

...
- TFO-Agent Docker image: `telemetryflow/telemetryflow-agent:1.3.3`
...
```bash
# Update image
kubectl -n telemetryflow set image ds/tfo-agent tfo-agent=telemetryflow/telemetryflow-agent:1.3.3

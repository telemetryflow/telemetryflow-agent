// Package plugin provides a registry for first- and third-party extensions
// (collectors, exporters, processors) that follow a common lifecycle interface:
// Info, Init, Start, and Stop.
//

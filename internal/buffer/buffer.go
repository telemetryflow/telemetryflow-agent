// Package buffer provides a disk-backed write-ahead buffer for telemetry
// data, ensuring no metrics, logs, or traces are lost during transient
// network outages or agent restarts.
//

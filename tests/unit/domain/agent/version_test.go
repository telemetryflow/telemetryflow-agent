// Package agent_test contains unit tests for the core Agent domain logic
// including lifecycle management, identity generation, and version metadata.
//
